...
import { ProductsPage } from "../pageObjects_ts/ProductsPage";
...
for (const data of dataSet)
{
    ...
    customtest (`PO End to End Playwright Test ${data.productName}`, async function({ browser }: { browser: Browser })
    {
        ...
        let orderId: string = await page.locator(".box label.ng-star-inserted").innerText();
